    ...
    <div class="d-flex flex-column flex-column-fluid align-items-center justify-content-center p-4">
        <div class="col-12 text-center">
            <a href="#" class="image mb-7 mb-sm-10">
                <img alt="Logo" src="{{ asset(getAppLogo()) }}" class="img-fluid" style="width:90px; background:#2187BA;">
            </a>
        </div>
        <div class="width-540">
        ...
        <div class="bg-white rounded-15 shadow-md width-540 px-5 px-sm-7 py-10 mx-auto">
            <h1 class="text-center mb-7">تسجيل الدخول</h1>
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="mb-sm-7 mb-4">
                    ...
                    <input name="email" type="email" class="form-control" id="email" aria-describedby="emailHelp" required placeholder="ادخل البريد الالكتروني">
                </div>
...
كلمة المرور<span
                    ...
                    <input name="password" type="password" class="form-control" id="password" required placeholder="ادخل كلمه المرور">
                </div>
