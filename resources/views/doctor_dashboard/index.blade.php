                ...
                <div class="col-12 mb-4">
                    <div class="row">
                        ...
                        <div class="col-12 mb-2">
                            <h1 style="font-weight: 700px; font-size:33px; color:#1B1B1B; line-height: 120%;">Dashboard</h1>
                        </div>
                ...
                {{-- boxes start --}}
                        ...
                        <div class="col-xxl-4 col-xl-4 col-md-6 widget">
                            <a href="{{ url('doctors/appointments') }}"
                               class="text-decoration-none">
                                <div class="p-xxl-10 px-7 py-10 d-flex align-items-center justify-content-between my-3" style="border-radius:8px; box-shadow: 0px 3px 20px 0px rgba(0, 0, 0, 0.08); background: #FFFFFF">
                                    ...
                                    <div class="text-end text-white">
                                        <h2 class="fs-1-xxl fw-bolder" style="color: #1B1B1B">{{$appointments['totalAppointmentCount']}}</h2>
                                        <h3 class="mb-0 fs-4 fw-light" style="color: #1B1B1B">{{__('messages.doctor_dashboard.total_appointments')}}</h3>
                                    </div>
                                </div>
                            </a>
                        </div>
                        ...
                        <div class="col-xxl-4 col-xl-4 col-md-6 widget">
                            <a href="{{ url('doctors/appointments') }}"
                               class="text-decoration-none">
                                <div
                                    class="p-xxl-10 px-7 py-10 d-flex align-items-center justify-content-between my-3" style="border-radius:8px; box-shadow: 0px 3px 20px 0px rgba(0, 0, 0, 0.08); background: #FFFFFF">
                                    <div
                                    ...
                                    <div class="text-end text-white">
                                        <h2 class="fs-1-xxl fw-bolder" style="color: #1B1B1B">{{$appointments['todayAppointmentCount']}}</h2>
                                        <h3 class="mb-0 fs-4 fw-light" style="color: #1B1B1B">{{__('messages.admin_dashboard.today_appointments')}}</h3>
                                    </div>
                                </div>
                            </a>
                        </div>
                            ...
                            <a href="{{ url('doctors/appointments') }}"
                               class="text-decoration-none">
                                <div
                                    ...
                                    <div class="text-end text-white">
                                        <h2 class="fs-1-xxl fw-bolder" style="color: #1B1B1B">{{$appointments['upcomingAppointmentCount']}}</h2>
                                        <h3 class="mb-0 fs-4 fw-light" style="color: #1B1B1B">{{__('messages.patient_dashboard.next_appointment')}}</h3>
                                    </div>
                                </div>
                            </a>
                        </div>
