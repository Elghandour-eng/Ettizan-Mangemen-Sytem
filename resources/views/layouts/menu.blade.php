...
@can('manage_admin_dashboard')
    <li class="nav-item {{ Request::is('admin/dashboard*') ? 'active' : '' }}">
        <a class="nav-link d-flex align-items-center py-4" aria-current="page"
           ...
           <span class="aside-menu-icon pe-3"><img class="sidebar-img-dash" src="{{ asset('assets/image/icons/Dashboard.png') }}" alt=""  width="20px" height="20px"></span>
            <span class="aside-menu-title title-dash">{{ __('messages.dashboard') }}</span>
        </a>
    </li>
@endcan
...
@can('manage_staff')
    <li class="nav-item {{ Request::is('admin/staffs*') ? 'active' : '' }}">
        <a class="nav-link d-flex align-items-center py-4" aria-current="page" href="{{ route('staffs.index') }}">
            <span class="aside-menu-icon pe-3"><img class="img-dash" src="{{ asset('assets/image/icons/staff.png') }}" alt=""  width="20px" height="20px"></span>
...
<li class="nav-item {{ Request::is('doctors/appointments*','doctors/patient*') ? 'active' : '' }}">
    <a class="nav-link d-flex align-items-center py-4" aria-current="page"
       href="{{ route('doctors.appointments') }}">
        ...
        <span class="aside-menu-icon pe-3"><img class="img-dash"  src="{{ asset('assets/image/icons/appoint.png') }}" alt=""  width="20px" height="20px"></span>
...
<li class="nav-item {{ Request::is('doctors/transactions*') ? 'active' : '' }}">
    <a class="nav-link d-flex align-items-center py-4" aria-current="page"
       href="{{ route('doctors.transactions') }}">
        ...
        <span class="aside-menu-icon pe-3"><img  class="img-dash" src="{{ asset('assets/image/icons/trans.png') }}" alt=""  width="20px" height="20px"></span>
...
<li class="nav-item {{ Request::is('doctors/visits*') ? 'active' : '' }}">
    <a class="nav-link d-flex align-items-center py-4" aria-current="page"
       href="{{ route('doctors.visits.index') }}">
        ...
        <span class="aside-menu-icon pe-3"><img class="img-dash" src="{{ asset('assets/image/icons/visit.png') }}" alt=""  width="20px" height="20px"></span>
...
@can('manage_doctors')
    <li class="nav-item {{ Request::is('admin/doctors*','doctors/doctor-sessions*','admin/doctor-sessions*') ? 'active' : '' }}">
        <a class="nav-link d-flex align-items-center py-4" aria-current="page"
           ...
           <span class="aside-menu-icon pe-3"><img class="img-dash" src="{{ asset('assets/image/icons/doctors.png') }}" alt=""  width="20px" height="20px"></span>
...
@can('manage_patients')
    ...
    <li class="nav-item {{ Request::is('admin/patients*') ? 'active' : '' }}">
        <a class="nav-link d-flex align-items-center py-4" aria-current="page"
           ...
           <span class="aside-menu-icon pe-3"><img class="img-dash" src="{{ asset('assets/image/icons/patients.png') }}" alt=""  width="20px" height="20px"></span>
...
@can('manage_services')
    <li class="nav-item {{ Request::is('admin/services*','admin/service-categories*') ? 'active' : '' }}">
        <a class="nav-link d-flex align-items-center py-4" aria-current="page"
           ...
           <span class="aside-menu-icon pe-3"><img class="img-dash" src="{{ asset('assets/image/icons/services.png') }}" alt=""  width="20px" height="20px"></span>
...
@can('manage_specialities')
    <li class="nav-item {{ Request::is('admin/specializations*') ? 'active' : '' }}">
        <a class="nav-link d-flex align-items-center py-4" aria-current="page"
           ...
           <span class="aside-menu-icon pe-3"><img class="img-dash" src="{{ asset('assets/image/icons/spec.png') }}" alt=""  width="20px" height="20px"></span>
...
@can('manage_settings')
    <li class="nav-item {{ Request::is('admin/settings*','admin/roles*','admin/currencies*','admin/clinic-schedules*','admin/countries*','admin/states*','admin/cities*','admin/holidays*') ? 'active' : '' }}">
        <a class="nav-link d-flex align-items-center py-4" aria-current="page"
           ...
           <span class="aside-menu-icon pe-3"><img class="img-dash" src="{{ asset('assets/image/icons/settings.png') }}" alt=""  width="20px" height="20px"></span>
